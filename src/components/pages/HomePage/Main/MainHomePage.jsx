...
import StyledMainHomePage from './StyledMainHomePage'
...
export default function MainHomePage() {
  return (
    ...
    <div className="heading">
        <h1 className="heading__text-own">Own your audience.</h1>
        <h1 className="heading__text-gradient">So you don't lose them.</h1>
      </div>
