...
import StyledMainAbout from "./StyledMainAbout";
import pathLogo from "../../../../icons/logo.svg";
import ProfilsAbout from "./ProfilsAbout/ProfilsAbout";
import { dataProfilsAbout } from "../../../../utils/dataProfilsAbout";
  ...
  return (
    <StyledMainAbout>
      ...
      <div className="our_mission">
        <h3>OUR MISSION</h3>
        <h2>We exist to help creators</h2>
        <br />
        <h2>own their audience.</h2>
        <p>
      ...
      <div className="team_heading_text">
        <h3>OUR TEAM</h3>
        <h2>We love creators</h2>
      </div>

      <ul>
        {dataProfilsAbout.map((items) => {
          return <ProfilsAbout key={items.id} dataPofil={items} />;
        })}
      </ul>
    </StyledMainAbout>
  );
